...
public interface SwiftListener extends ParseTreeListener {
	...
	void enterFunction_type(SwiftParser.Function_typeContext ctx);
	void exitFunction_type(SwiftParser.Function_typeContext ctx);
	...
	void enterOptional_type(SwiftParser.Optional_typeContext ctx);
	void exitOptional_type(SwiftParser.Optional_typeContext ctx);
	...
	void enterImplicitly_unwrapped_optional_type(SwiftParser.Implicitly_unwrapped_optional_typeContext ctx);
	void exitImplicitly_unwrapped_optional_type(SwiftParser.Implicitly_unwrapped_optional_typeContext ctx);
